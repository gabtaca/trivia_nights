  ...
  return (
    <div className="z-0 bg-brick-background bg-repeat bg-contain bg-[#31325D] w-full h-[100vh]">
      ...
      <main className=" flex flex-col justify-center items-center w-full h-full">
        <div className="main_modal z-40 flex flex-col items-center bg-[#2B0B38] bg-opacity-[79%] w-[90%] h-[80%] rounded-[50px] justify-evenly">
          <div className="logo ">
          ...
          <div className="welcome_text flex flex-col font-montserrat font-bold text-white text-[12px] gap-6 p-6 text-center sm:w-270px ">
          ...
          <button className="font-montserrat font-bold text-white text-[12px] text-center border-[3.2px] rounded-full border-[#FF38D3] bg-[#430086] w-[196px] h-[42px] p-[10.6px]  items-center ">START</button>
